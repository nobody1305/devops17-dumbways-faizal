...
copy script tersebut dan paste di pipeline

```
discordSend description: 'wayshub project', footer: 'dumbways jaya', image: '', link: 'env.BUILD_URL.', result: 'currentBuild.resultIsBetterOrEqualTo(\'SUCCESS\')', scmWebUrl: '', thumbnail: '', title: 'env.JOB_NAME.', webhookURL: 'https://discordapp.com/api/webhooks/1129367074859397140/B2AL8n5a9Teg2FKSa82tuemNOu3SBe4XenTefkM6Q59vXpniLObl-ev0CIa9DdSWAGcQ'
```
